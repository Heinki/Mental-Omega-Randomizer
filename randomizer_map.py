...
SCRIPTED_TECH_LOCK_EXCLUSIONS = {
    ...
    # BuildLimit/PrerequisiteOverride blocks player production while keeping
    # scripted teams safer than a hard TechLevel lock.
...
LOCKED_PREREQUISITE = 'MOR_RANDOMIZER_LOCK'
