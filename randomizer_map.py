...
def mission_house_color_rules(
    ...
    """Return deterministic per-House color overrides for a launched map.

    Player-controlled houses share the selected color. Rainbowizer colors all
    other non-civilian AI houses, including allies, while neutral/script-only
    civilian houses retain the map author's color.
    """
    records = map_house_records(lines)
    player_houses = set(
