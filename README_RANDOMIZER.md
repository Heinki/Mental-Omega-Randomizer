...
Five further permanent upgrades are available: **Coupon Book** discounts the first paid purchase of each stage; **Stock Lock** preserves one selected access offer into the next stage; **Veteran Academy** makes selected permanent-loadout units Veteran; **Gem Dividend** converts capped remaining Ore into bonus Gems on run victory; and **Premium Supplier** guarantees a later-stage higher-tier access offer. These upgrades add progress without penalties.
