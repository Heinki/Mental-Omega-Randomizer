...
7. When you finish objectives or win a mission, return to the launcher. The launcher should detect most objective/victory rewards automatically; use `Mark Complete` only if the victory reward was missed.
...
- some maps need more hook validation
- unit cameo images are not shown in the UI yet
