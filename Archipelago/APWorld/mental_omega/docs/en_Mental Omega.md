...
Randomizer 1.27. It supports all 3,792 native rewards and 17,640 stable
possible reward-slot locations across the full 97-mission catalogue. Each seed
activates only the locations and item counts described by its manifest.
