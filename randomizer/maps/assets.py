...
GENERATED_UNIT_CAMEO_ASSETS = {
    'PERUN': {
        'image': 'perun_flagship.png',
        'pcx': 'morperunicon.pcx',
    },
}
...
def generated_unit_art_aliases(map_path, art_text):
    ...
    # PERUN has a complete voxel in the installed archives but intentionally
    # no installed art section because it is normally never buildable.
    if perun_used and 'PERUN' not in art_sections:
        aliases['PERUN'] = {
            'Voxel': 'yes',
            'Remapable': 'yes',
